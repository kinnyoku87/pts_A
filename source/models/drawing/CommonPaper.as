package models.drawing {
	...
	import models.drawing.supportClasses.EraseBrush;
	 ...
	 *  	10. clear
	 */
public class CommonPaper extends PaperBase implements ITicker {
	...
	public function CommonPaper( paperWidth:int, paperHeight:int, pixelRatio:Number = 1, base:BitmapData = null, maxSize:int = 1024 ) {
		...
		Agony.getLog().message(this, "width: " + width + "...height: " + height + "...contentRatio: " + m_contentRatio + "...fitRatio: " + m_fitRatio + "...")
	...
	public function set brushIndex( v:int ) : void {
		...
		if(!m_currBrush){
			Agony.getLog().error(this, "set brushIndex", "an inexistent brush...!!")
		}
	...
	public function createCopyPixelsBrush( source:IBitmapDrawable, index:int, density:Number ) : IBrush {
		...
		Agony.getLog().message(this, "Add copy-pixels brush [ " + index + " ]...")
		return brush
	}
	...
	public function createTransformationBrush( sourceList:Array, index:int, density:Number, appendScaleLow:Number = 0, appendScaleHigh:Number = 0, rotatable:Boolean = true) :IBrush {
		...
		Agony.getLog().message(this, "Add transformation brush [ " + index + " ]...")
		return brush 
	}
